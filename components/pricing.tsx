    ...
    <section id="pricing" className="bg-white dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <h2 className="h2 mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
            Designed for business teams like yours
          </h2>
          <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
            Choose the plan that works for your team. No hidden fees or
            contracts.
          </p>
        </div>
        <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>
                  Team size: <span className="font-semibold">1 machine</span>
                </span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>
                  Team size: <span className="font-semibold">3 machines</span>
                </span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            <h3 className="mb-4 text-2xl font-semibold">On a tight budget?</h3>
            <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
              Pay as much as you want. Your contribution helps us enhance the
              app and cover server costs.
            </p>
            <div className="flex justify-center items-baseline my-8">
